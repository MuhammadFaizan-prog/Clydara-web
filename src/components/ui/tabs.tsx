...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-none border-2 border-black bg-muted p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
